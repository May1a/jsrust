 ...
 * @returns {TypeError[]}
 */
function collectUnsupportedGenericConstraintErrors(fnItem: Node): TypeError[] {
    const errors = [];
 ...
 */
function lookupDirectFunctionItemForCall(ctx: TypeContext, callee: Node): import('../type_context').ItemDecl | null {
 ...
 * @returns {InferenceResult}
 */
function inferGenericFunctionCall(ctx: TypeContext, call: Node, itemDecl: import('../type_context').ItemDecl): InferenceResult {
 ...
 * @returns {UnifyResult}
 */
function unify(ctx: TypeContext, t1: Type, t2: Type): UnifyResult {
 ...
 * @returns {string[]}
 */
function extractTypeNodeGenericParamNames(typeNode: Node | null | undefined): string[] {
    if (
        !typeNode ||
 ...
 * @returns {FnType}
 */
function instantiateMethodTypeForReceiver(ctx: TypeContext, fnType: FnType, receiverType: Type, meta: any): FnType {
 ...
 * @returns {string}
 */
function intWidthToName(width: number): string {
    switch (width) {
        case IntWidth.I8:
            return "i8";
        case IntWidth.I16:
 ...
 * @returns {string}
 */
function floatWidthToName(width: number): string {
    switch (width) {
        case FloatWidth.F32:
            return "f32";
        case FloatWidth.F64:
 ...
 * @returns {InferenceResult}
 */
function resolveImplTargetType(ctx: TypeContext, typeNode: Node): InferenceResult {
 ...
 */
function inferModule(ctx: TypeContext, module: Node): { ok: boolean, errors?: TypeError[] } {
 ...
 * @returns {{ ok: boolean, errors?: TypeError[] }}
 */
function gatherDeclarations(ctx: TypeContext, module: Node): { ok: boolean, errors?: TypeError[] } {
    const errors = [];
 ...
 * @returns {{ ok: boolean, errors?: TypeError[] }}
 */
function gatherDeclaration(ctx: TypeContext, item: Node): { ok: boolean, errors?: TypeError[] } {
    switch (item.kind) {
 ...
 * @returns {InferenceResult}
 */
function inferFnSignature(ctx: TypeContext, fnItem: Node): InferenceResult {
    const paramTypes = [];
 ...
 * @returns {InferenceResult}
 */
function resolveTypeNode(ctx: TypeContext, typeNode: Node): InferenceResult {
 ...
 * @returns {boolean}
 */
function isCopyableInContext(ctx: TypeContext, ty: Type, visiting: Set<string> = new Set()): boolean {
 ...
 * @returns {CheckResult}
 */
function checkModuleItems(ctx: TypeContext, module: Node): CheckResult {
    const errors = [];
 ...
 * @returns {CheckResult}
 */
function checkItem(ctx: TypeContext, item: Node): CheckResult {
    switch (item.kind) {
        case NodeKind.FnItem:
 ...
 * @returns {CheckResult}
 */
function checkFnItem(ctx: TypeContext, fnItem: Node): CheckResult {
 ...
 * @returns {InferenceResult}
 */
function inferExpr(ctx: TypeContext, expr: Node, expectedType: Type = undefined): InferenceResult {
    switch (expr.kind) {
 ...
 * @returns {InferenceResult}
 */
function inferLiteral(ctx: TypeContext, literal: Node, expectedType: Type = undefined): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferIdentifier(ctx: TypeContext, ident: Node): InferenceResult {
    if (ident.name === "Self") {
        const selfType = ctx.currentImplSelfType();
        if (selfType) {
            return ok(selfType);
 ...
 * @returns {InferenceResult}
 */
function inferBinary(ctx: TypeContext, binary: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferUnary(ctx: TypeContext, unary: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferCall(ctx: TypeContext, call: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferClosure(ctx: TypeContext, closure: Node, expectedType: Type = undefined): InferenceResult {
    if (closure.isMove) {
 ...
 * @returns {InferenceResult}
 */
function inferField(ctx: TypeContext, field: Node, preferMethod: boolean = false): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferIndex(ctx: TypeContext, index: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferAssign(ctx: TypeContext, assign: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferIf(ctx: TypeContext, ifExpr: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferMatch(ctx: TypeContext, matchExpr: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferBlock(ctx: TypeContext, block: Node): InferenceResult {
    ctx.pushScope();
 ...
 * @returns {InferenceResult}
 */
function inferLoop(ctx: TypeContext, loopExpr: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferWhile(ctx: TypeContext, whileExpr: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferFor(ctx: TypeContext, forExpr: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferReturn(ctx: TypeContext, returnExpr: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferBreak(ctx: TypeContext, breakExpr: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferContinue(ctx: TypeContext, continueExpr: Node): InferenceResult {
    const loopCtx = ctx.currentLoop();
    if (!loopCtx) {
 ...
 * @returns {InferenceResult}
 */
function inferPath(ctx: TypeContext, pathExpr: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferStructExpr(ctx: TypeContext, structExpr: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferRange(ctx: TypeContext, rangeExpr: Node): InferenceResult {
    const errors = [];
 ...
 * @returns {InferenceResult}
 */
function inferRef(ctx: TypeContext, refExpr: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferDeref(ctx: TypeContext, derefExpr: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferMacro(ctx: TypeContext, macroExpr: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function checkStmt(ctx: TypeContext, stmt: Node): InferenceResult {
    switch (stmt.kind) {
 ...
 * @returns {InferenceResult}
 */
function checkLetStmt(ctx: TypeContext, letStmt: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function checkExprStmt(ctx: TypeContext, exprStmt: Node): InferenceResult {
 ...
 * @returns {InferenceResult}
 */
function inferPattern(ctx: TypeContext, pattern: Node): InferenceResult {
    switch (pattern.kind) {
 ...
 * @returns {CheckResult}
 */
function checkPattern(ctx: TypeContext, pattern: Node, expectedType: Type): CheckResult {
 ...
 * @returns {{ ok: boolean, errors?: TypeError[] }}
 */
function finalizeInference(ctx: TypeContext): { ok: boolean, errors?: TypeError[] } {
    const errors = [];
