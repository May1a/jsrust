...
import { HStmtKind, HExprKind, HPatKind } from "../../src/hir";
import {
    TypeKind,
    IntWidth,
    makeUnitType,
...
function testLowerBlockWithFinalExpr() {
    ...
    const finalExpr = makeLiteralExpr(
        makeSpan(0, 0, 0, 1),
        LiteralKind.Int,
        42,
        "42",
...
export function runTests() {
    const tests = [
        ...
        [
            "Lower expr stmt with function call",
            testLowerExprStmtWithFunctionCall,
        ],
        ...
        [
            "Lower block with stmts and final expr",
            testLowerBlockWithStmtsAndFinalExpr,
        ],
    ];
