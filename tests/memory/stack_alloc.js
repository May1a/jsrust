...
import { IRTypeKind, makeIRFunction, makeIRParam, addIRLocal, makeIRLocal, resetIRIds } from '../../ir.js';
...
test('StackAllocator allocates single slot', () => {
    ...
    const local = { id: 0, ty: { kind: IRTypeKind.Int, width: IntWidth.I32 }, name: 'x' };
...
test('StackAllocator allocates multiple slots', () => {
    ...
    const local1 = { id: 0, ty: { kind: IRTypeKind.Int, width: IntWidth.I32 }, name: 'x' };
    const local2 = { id: 1, ty: { kind: IRTypeKind.Int, width: IntWidth.I32 }, name: 'y' };
...
test('StackAllocator handles different alignments', () => {
    ...
    const local1 = { id: 0, ty: { kind: IRTypeKind.Int, width: IntWidth.I32 }, name: 'x' };
    const local2 = { id: 1, ty: { kind: IRTypeKind.Int, width: IntWidth.I64 }, name: 'y' };
...
test('computeFrame handles function with locals', () => {
    ...
    const fn = makeIRFunction(0, 'test', [], { kind: IRTypeKind.Unit });
    addIRLocal(fn, makeIRLocal(0, { kind: IRTypeKind.Int, width: IntWidth.I32 }, 'x'));
    addIRLocal(fn, makeIRLocal(1, { kind: IRTypeKind.Int, width: IntWidth.I32 }, 'y'));
...
test('computeFrame sorts locals by alignment', () => {
    ...
    addIRLocal(fn, makeIRLocal(1, { kind: IRTypeKind.Int, width: IntWidth.I64 }, 'b'));  // align 8
    addIRLocal(fn, makeIRLocal(2, { kind: IRTypeKind.Int, width: IntWidth.I32 }, 'c'));  // align 4
...
test('computeFrameWithParams handles parameters', () => {
    ...
    const fn = makeIRFunction(0, 'test', [
    ...
    addIRLocal(fn, makeIRLocal(0, { kind: IRTypeKind.Int, width: IntWidth.I64 }, 'x'));
