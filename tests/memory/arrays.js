...
test('layoutArray returns empty layout for zero elements', () => {
    ...
    const layout = layoutArray({ kind: IRTypeKind.Int, width: IntWidth.I32 }, 0, cache);
...
test('layoutArray calculates layout for single i32', () => {
    const cache = new LayoutCache();
    const layout = layoutArray({ kind: IRTypeKind.Int, width: IntWidth.I32 }, 1, cache);
...
test('layoutArray calculates layout for multiple i32s', () => {
    const cache = new LayoutCache();
    const layout = layoutArray({ kind: IRTypeKind.Int, width: IntWidth.I32 }, 10, cache);
...
test('layoutArray calculates layout for i8 array', () => {
    const cache = new LayoutCache();
    const layout = layoutArray({ kind: IRTypeKind.Int, width: IntWidth.I8 }, 100, cache);
...
test('layoutArray calculates layout for i64 array', () => {
    const cache = new LayoutCache();
    const layout = layoutArray({ kind: IRTypeKind.Int, width: IntWidth.I64 }, 5, cache);
...
test('layoutArray calculates layout for f64 array', () => {
    const cache = new LayoutCache();
    const layout = layoutArray({ kind: IRTypeKind.Float, width: FloatWidth.F64 }, 3, cache);
...
test('layoutArray calculates layout for nested array', () => {
    const cache = new LayoutCache();
    // [i32; 4] inner array
    const innerArray = { kind: IRTypeKind.Array, element: { kind: IRTypeKind.Int, width: IntWidth.I32 }, length: 4 };
    // [[i32; 4]; 3] outer array
...
test('layoutArray uses element alignment', () => {
    ...
    const layout = layoutArray({ kind: IRTypeKind.Int, width: IntWidth.I64 }, 2, cache);
...
test('layoutArray calculates layout for large array', () => {
    const cache = new LayoutCache();
    const layout = layoutArray({ kind: IRTypeKind.Int, width: IntWidth.I32 }, 1000, cache);
